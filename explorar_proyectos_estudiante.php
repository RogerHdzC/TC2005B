...
<body>
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
      <?php if ($pagina > 1){ ?>
        <li class="page-item">
          <a class="page-link" href="explorar_proyectos_estudiante.php?pagina=<?php echo $pagina - 1 ?>" tabindex="-1">Previous</a>
        </li>
      <?php } ?>
      <?php for($x=1; $x <= $paginas; $x++) {?>
        <li class="page-item"><a class="page-link" href="explorar_proyectos_estudiante.php?pagina=<?php echo $x ?>"><?php echo $x ?></a></li>
        <?php } ?>
      <?php if($pagina < $paginas) { ?>
      <li class="page-item">
        <a class="page-link" href="explorar_proyectos_estudiante.php?pagina=<?php echo $pagina + 1 ?>">Next</a>
      </li>
      <?php } ?>
    </ul>
  </nav>
