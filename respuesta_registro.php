    ...
    if ($q->rowCount() > 0) {
        ...
        echo "<div class='container'>";
                    echo "<div class='row'>";
                        ...
                        echo "<a href='inicio_sesion.html'><button type='button' class='btn btn-primary btn-custom btn-p1'>Iniciar Sesión</button></a>";
                        echo "</div>";
                        echo "<div class='col-6'>";
                        echo "<a href='index.html'><button type='button' class='btn btn-primary btn-custom btn-p1'>Inicio</button></a>";
                        echo "</div>";
                    echo "</div>";
                echo "</div>";
        Database::disconnect();
